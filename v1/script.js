...
async function loadFacts() {
  const res = await fetch(
    "https://ketkmnmqvwkjbxapaonl.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authentication:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtldGttbm1xdndramJ4YXBhb25sIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzM5NTcsImV4cCI6MjA1MDQwOTk1N30.ML15SOMFPFc61Y553dqm8fV6pT_r9jXbiY-14yGERqQ",
      },
    }
  );
